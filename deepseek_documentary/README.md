...
**8K notes.** 7680×4320 frames use ~130 MB each in Cairo, so keep workers × 2 GB under RAM. The preset uses 30 fps to keep file size and render time sane; override with `--fps 60`.
