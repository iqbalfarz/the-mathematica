"""Generate narration audio for every beat and write build/audio/timing.json.
    ...
    python -m enigma_doc.narration.generate_voice            # all scenes (cached)
    python -m enigma_doc.narration.generate_voice --scene s0301 --force
...
from ..paths import AUDIO, TIMING, ensure_dirs
